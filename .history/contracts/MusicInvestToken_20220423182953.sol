    ...
    ERC20
{
    ...
    address umaOracle = 0xbb1a8db2d4350976a11cdfa60a1d43f97710da49;
    ...
    function distribute(uint256 cashAmount) external onlyOwner {
        ...
        (bool success, bytes memory data) =  owner.call(abi.encodeWithSignature("requestPrice(bytes32,uint256)", thing, block.timestamp));
