    ...
    ERC20
{
    ...
    address public umaOracle = 0xbb1a8db2d4350976a11cdfa60a1d43f97710da49;
        ...
        ERC20(name, symbol)
    {
        ...
        _host.callAgreement(
            _ihttps://betterprogramming.pub/how-to-write-complex-truffle-migrations-86d4b85d7783
    ...
    function distribute(uint256 cashAmount) external onlyOwner {
        ...
        // (bool success, bytes memory result) = umaOracle.delegatecall(abi.encodeWithSignature("requestPrice()"));
