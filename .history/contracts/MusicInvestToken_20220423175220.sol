    ...
    ERC20
{
    ...
    address constant public umaOracle = 0xbb1a8db2d4350976a11cdfa60a1d43f97710da49;
    ...
    function distribute(uint256 cashAmount) external onlyOwner {
        ...
        (bool success, bytes memory result) = umaOracle.delegatecall(abi.encodeWithSignature("requestPrice(thing, now)"));
